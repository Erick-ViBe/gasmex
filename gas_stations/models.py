...
class GasStation(models.Model):
    ...
    regular_gasoline_price = models.FloatField("Precio de gasolina regular", null=True, blank=True)
    premium_gasoline_price = models.FloatField("Precio de gasolina premium", null=True, blank=True)
    diesel_price = models.FloatField("Precio de gasolina premium", null=True, blank=True)
